...
const
  ...
  LOB_VISIBLE           = $80000000; 
  LOB_GDI_OVERLAY       = $40000000; 
  LOB_MOUSE_EVENTS      = $20000000; 
  LOB_NO_UPDATE         = $10000000; 
  LOB_NO_CAPTURE        = $08000000; 
  LOB_INVALID           = $04000000; 
  LOB_FORCE_UPDATE      = $02000000; 
  LOB_RESERVED_24       = $01000000; 
...
uses
  TypInfo, GR32_LowLevel, GR32_Resamplers, GR32_RepaintOpt;
...
begin
  ...
  begin
    Result := Items[I];
    if (Result.LayerOptions and OptionsMask) = 0 then Continue; 
...
begin
  Changing;
  FLayerOptions := Value and not LOB_NO_UPDATE; 
  Changed;
end;
